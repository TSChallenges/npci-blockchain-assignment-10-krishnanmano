...
export CORE_PEER_TLS_ROOTCERT_FILE=$PWD/../fabric-samples/test-network/organizations/peerOrganizations/Medlife.example.com/peers/peer0.Medlife.example.com/tls/ca.crt
export CORE_PEER_MSPCONFIGPATH=$PWD/../fabric-samples/test-network/organizations/peerOrganizations/Medlife.example.com/users/Admin@Medlife.example.com/msp
...
export CORE_PEER_TLS_ROOTCERT_FILE=$PWD/../fabric-samples/test-network/organizations/peerOrganizations/Apollo.example.com/peers/peer0.Apollo.example.com/tls/ca.crt
export CORE_PEER_MSPCONFIGPATH=$PWD/../fabric-samples/test-network/organizations/peerOrganizations/Apollo.example.com/users/Admin@Apollo.example.com/msp
...
export CORE_PEER_TLS_ROOTCERT_FILE=$PWD/../fabric-samples/test-network/organizations/peerOrganizations/CDSCO.example.com/peers/peer0.CDSCO.example.com/tls/ca.crt
export CORE_PEER_MSPCONFIGPATH=$PWD/../fabric-samples/test-network/organizations/peerOrganizations/CDSCO.example.com/users/Admin@CDSCO.example.com/msp
